...
$check_sql = "SELECT question_number FROM tbl_quiz_questions WHERE question_number = '$question_number'";
$check_result = mysqli_query($conn, $check_sql);

if (mysqli_num_rows($check_result) > 0) {
    // If question number exists, update the existing record
    $update_sql = "UPDATE tbl_quiz_questions SET question = '$question', choice_a = '$choice_a', choice_b = '$choice_b', choice_c = '$choice_c', choice_d = '$choice_d', correct_answer = '$correct_answer', credit_points = '$credit_points', category = $category WHERE question_number = '$question_number'";
    ...
    // If question number does not exist, insert a new record
